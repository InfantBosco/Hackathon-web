...
export const GridBackground: React.FC<GridBackgroundProps> = ({
  ...
  return (
    <div id={id} className={cn('relative w-full overflow-hidden bg-transparent', className)}>
      ...
      {glow && (
        <>
          <div className="absolute top-0 left-1/4 -translate-x-1/2 w-[500px] h-[500px] bg-white opacity-5 blur-[140px] pointer-events-none rounded-full" />
          <div className="absolute top-1/3 right-10 w-[400px] h-[400px] bg-slate-200 opacity-5 blur-[140px] pointer-events-none rounded-full" />
        </>
      )}
