  ...
  return (
    <Section id="details" variant="secondary">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Core Rules Overview */}
        <Card variant="default" className="md:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div className="p-4 rounded-[var(--radius-md)] bg-[var(--color-surface-elevated)] border border-[var(--color-border-subtle)]">
              <span className="text-xs font-mono text-[var(--color-accent-cyan)] block mb-1">TEAM STRUCTURE</span>
            ...
            <div className="p-4 rounded-[var(--radius-md)] bg-[var(--color-surface-elevated)] border border-[var(--color-border-subtle)]">
              <span className="text-xs font-mono text-[var(--color-accent-cyan)] block mb-1">REGISTRATION FEE</span>
              <p className="font-semibold text-white mb-1">₹{siteConfig.registrationFee} / Team</p>
              <p className="text-xs text-[var(--color-text-secondary)]">Covers registration & event access.</p>
            </div>

            <div className="p-4 rounded-[var(--radius-md)] bg-[var(--color-surface-elevated)] border border-[var(--color-border-subtle)]">
              <span className="text-xs font-mono text-[var(--color-accent-cyan)] block mb-1">CODE OF CONDUCT</span>
            ...
            <div className="p-4 rounded-[var(--radius-md)] bg-[var(--color-surface-elevated)] border border-[var(--color-border-subtle)]">
              <span className="text-xs font-mono text-[var(--color-accent-cyan)] block mb-1">FOOD PREFERENCES</span>
        ...
        <Card variant="hoverGlow" className="flex flex-col justify-between">
          <div>
            <div className="w-12 h-12 rounded-[var(--radius-md)] bg-[rgba(0,240,255,0.1)] border border-[rgba(0,240,255,0.3)] flex items-center justify-center mb-4">
