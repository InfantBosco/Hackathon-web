export const aboutData = {
  badge: 'ABOUT HACKNEX',
  title: 'India\'s Premier Student Innovation Hackathon',
  description:
    'HackNEX 2026 is a 24 Hour National Level Hackathon organized by the NEXUS Club at Divison of CSE , Karunya Institute of Technology and Sciences. Designed to foster high-impact technical innovation, HackNEX brings together 1,500+ passionate developers, designers, and problem solvers across India.',
  agenda:
  ...
  stats: [
    ...
    { id: '3', prefix: '₹', end: 500, label: 'Registration / Person' },
    { id: '4', end: 2, label: 'Days Sprint' },
  ],
};
